...
HRESULT DBOXFont::Create(char* FontFace ,LPDIRECT3DDEVICE9 d3ddev, int Width , int Height , int Weight , DWORD TextColor)
{
	...
	strcpy_s(FontDesc.FaceName , FontFace);
...
HRESULT DBOXFont::DrawText(char* Text , int x , int y)
{
...
HRESULT DBOXFont::DrawText(char* Text , long TextLenght , int x , int y)
{	
	if(Font == NULL) return DBOXFONTE_;
...
HRESULT DBOXFont::DrawTextEx(char* Text ,DWORD Format ,const LPRECT Rect)
{
