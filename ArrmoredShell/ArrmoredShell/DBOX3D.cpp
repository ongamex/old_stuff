...
{
	d3dpp = pp;//cpy and use own instance
...
HRESULT	DBOX3D::HandleLostDevice(DWORD SleepTime)
{
...
LPDIRECT3DTEXTURE9 DBOX3D::	CreateTextureFromFile(tstring FileName, DWORD ColorKey, LONG Width, LONG Height)
{
	...
	HRESULT hr = D3DXCreateTextureFromFileEx(d3ddev , FileName.c_str() , Width , Height , D3DX_DEFAULT , 0 , 
		D3DFMT_A8R8G8B8 , 
		D3DPOOL_MANAGED , 
		D3DX_FILTER_LINEAR , 
		D3DX_FILTER_LINEAR , 
