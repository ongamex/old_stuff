...
LPDIRECT3DTEXTURE9 DBOX3D::	CreateTextureFromFile(tstring FileName, DWORD ColorKey, LONG Width, LONG Height)
{
	...
	HRESULT hr = D3DXCreateTextureFromFileExA(d3ddev , FileName.c_str() , Width , Height , 0 , 0 , D3DFMT_A8R8G8B8 , D3DPOOL_MANAGED , D3DX_FILTER_LINEAR , D3DX_FILTER_LINEAR , ColorKey , NULL , NULL , &retval);
